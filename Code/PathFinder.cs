...
namespace MeraCircuitBoard
{
    ...
    internal class PathFinder
    {
        ...
        {
            Rect rect = new Rect(connectorThumb.CircuitPartLeft,
                                 connectorThumb.CircuitPartTop,
                                 connectorThumb.CircuitPartSize.Width,
                                 connectorThumb.CircuitPartSize.Height);
